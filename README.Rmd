...
`fmt_beta_md()` is an experimental function for getting model effects formatted
in markdown. You give the function a model, an effect and a string listing the
quantities you want.
...
`r fmt_beta_md(model, "woolB", "besp")`
...
`r fmt_beta_md(model, "woolB", terms = "bp")`
...
`r  fmt_beta_md(model, "woolB", terms = "Bp", b_lab = "Wool B")`
...
`r fmt_beta_md(model, "woolB", terms = "bi")`
...
`r fmt_beta_md(model, "woolB", terms = "bSp")`
...
`r fmt_beta_md(model, "woolB", terms = "bep", digits = 6)`
